...
@bot.command(name='notify', help="Start the notification system")
async def notification(ctx):

    embed = discord.Embed(title=f"Initiated Takeover notifications.", color=0x00ff40)
    ...
    while True:
        ...
        if newerNotifications != currNotifications: 
            ...
            new_embed = discord.Embed(title=f"Found New Takeover!", color=0x00ff40) 
